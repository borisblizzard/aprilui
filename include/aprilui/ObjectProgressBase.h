...
namespace aprilui
{
	...
	public:
		...
		HL_DEFINE_GETSET(unsigned char, progressColor.r, ProgressRed);
		HL_DEFINE_GETSET(unsigned char, progressColor.g, ProgressGreen);
		HL_DEFINE_GETSET(unsigned char, progressColor.b, ProgressBlue);
		HL_DEFINE_GETSET(unsigned char, progressColor.a, ProgressAlpha);
		HL_DEFINE_GETSET(april::Color, antiProgressColor, AntiProgressColor);
		HL_DEFINE_GETSET(unsigned char, antiProgressColor.r, AntiProgressRed);
		HL_DEFINE_GETSET(unsigned char, antiProgressColor.g, AntiProgressGreen);
		HL_DEFINE_GETSET(unsigned char, antiProgressColor.b, AntiProgressBlue);
		HL_DEFINE_GETSET(unsigned char, antiProgressColor.a, AntiProgressAlpha);
		HL_DEFINE_GETSET(april::Color, maskColor, MaskColor);
		HL_DEFINE_GETSET(unsigned char, maskColor.r, MaskRed);
		HL_DEFINE_GETSET(unsigned char, maskColor.g, MaskGreen);
		HL_DEFINE_GETSET(unsigned char, maskColor.b, MaskBlue);
		HL_DEFINE_GETSET(unsigned char, maskColor.a, MaskAlpha);
