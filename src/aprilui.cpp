...
namespace aprilui
{
	...
	void init()
	{
		...
		REGISTER_ANIMATOR_TYPE(AntiProgressGreenChanger);
		REGISTER_ANIMATOR_TYPE(AntiProgressRedChanger);
		...
		REGISTER_ANIMATOR_TYPE(PivotMoverX);
		REGISTER_ANIMATOR_TYPE(PivotMoverY);
		REGISTER_ANIMATOR_TYPE(ProgressAlphaChanger);
		REGISTER_ANIMATOR_TYPE(ProgressBlueChanger);
		REGISTER_ANIMATOR_TYPE(ProgressChanger);
		REGISTER_ANIMATOR_TYPE(ProgressGreenChanger);
		REGISTER_ANIMATOR_TYPE(ProgressRedChanger);
